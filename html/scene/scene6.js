;require(['anole', 'zepto'], function (anole){
	...
	anole.addScene({
		onInit: function (){
			...
			$("#scene5").hide();
			this.ctn_browser = anole.$$("#scene6 #ctn-browser",'<div id = "ctn-browser" class = "ctn-browser"></div>',this.scene);
			this.browser = anole.$$("#scene6 #browser",'<div id = "browser" class = "browser"></div>',this.browser_block);
