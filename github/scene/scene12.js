require(['anole', 'zepto'], function(anole, Scene) {
    ...
    scene.createDom = function() {
        ...
        this.video = anole.getVideo('french'); // video is an html <video> element
		$(this.video).hide().appendTo(this.bg);
    };
    ...
    scene.cleanup = function() {
        if (this.video) {
			...
			anole.putbackVideo('french', this.video);
		}
		this.videoBG && this.videoBG.remove();
        this.koreanContainer && this.koreanContainer.remove();
    };
